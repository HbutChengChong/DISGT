...
class MyFSPGraphDataset(DGLDataset):
    ...
    def __init__(self, name, path_save_graph, path_save_Sub, url=None, raw_dir=None, save_dir=None, force_reload=False, verbose=True):
        ...
        # self.Gname = os.listdir(os.path.join(rf'C:\Users\HP\PycharmProjects\Transformer\data\Block_graph_data_DSP\{name}_32\Graph_set'))
        ...
        self.DSP_Subspace_list_name = os.listdir(os.path.join(self.path_save_Sub))
    ...
    def __getitem__(self, idx):
        ...
        Subspace_list_name = self.DSP_Subspace_list_name[idx]
